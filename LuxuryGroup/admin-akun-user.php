<?php
    ...
    if(isset($_POST['cari'])){
        ...
        $result = mysqli_query($conn, "SELECT * FROM tb_user WHERE (role != 'admin') AND (username LIKE '%$keyword%' OR nama LIKE '%$keyword%')");
    }else{
...
<body>
    <section class='user-header-index'>
        ...
        <div class='content-index'>
            <h1 class="user-title">DATA AKUN USER</h1>
            <p class="user-sub-title">Menmpilkan semua data akun user sesuai dengan apa yang telah terdaftar dari menu pendaftaran dan admin dapat menghapus data customer yang ada</p>
        </div>
    </section>
        ...
        <div class="user-table-container">
            ...
            <table class="user-table">
                <tr>
                    ...
                    <th class="user-title-table">Nama</th>
                    <th class="user-title-table">Akun Dibuat</th>
                ...
                <tr>
                    ...
                    <td class="user-sub-title-table"><?php echo $tb_user['nama']; ?></td>
                    <td class="user-sub-title-table"><?php echo $tb_user['akun_dibuat']; ?></td>
                    <td class="user-sub-title-table"> 
                        <a href="admin-delete-akun.php?id=<?php echo $tb_user["id"]; ?>" onclick="return confirm('Yakin ingin Menghapus akun ini?')" role='button'><i class='bx bxs-trash-alt'></i></a>
                    </td>
                </tr>
                <?php $i++; endforeach; ?>
            </table>
